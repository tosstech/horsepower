      ...
      <li v-for="item in pro" :key="item.index" >
          <div class="tag_item" ref="ImgPic">
            ...
            <div class="tag_title">
              ...
              <li>
                <img :src="restPro[3].url"/>
                <div class="tag_room_price">
                  <span>￥</span>
                  <span>{{restPro[3].price}}</span>
                  <span>元</span>
                </div>
              </li>
  ...
  components: {
    ...
    data(){
        return{
          ...
          restPro:[
            {id:1,price:89,url:require(`@/assets/room_1.jpg`)},
            {id:1,price:189,url:require(`@/assets/room_2.jpg`)},
            {id:2,price:56,url:require(`@/assets/room_3.jpg`)},
            {id:2,price:69,url:require(`@/assets/room_4.jpg`)},
            /*
    ...
    methods:{
      ImgList(){
            for (let i=0;i<5;i++) {
                let pic = {}
                pic.url = require(`@/assets/hotel_${i+1}.jpg`)
                let img = new Image();
                img.src= pic.url
